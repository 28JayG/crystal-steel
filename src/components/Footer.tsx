        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-sm text-slate-400 leading-relaxed max-w-xs">
              Precision-engineered metal products built for strength, reliability, and lasting performance in demanding global projects.
            </p>
            {/* Social Icons */}
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3 text-sm">
              <li>
                <Link href="/products/steel" className="hover:text-amber-500 transition-colors">
                  Steel Sheets
                </Link>
              </li>
              <li>
                <Link href="/products/pipes-tubes" className="hover:text-amber-500 transition-colors">
                  Metal Pipes
                </Link>
              </li>
              <li>
                <Link href="/products/structural" className="hover:text-amber-500 transition-colors">
                  Structural Beams
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/products/custom" className="hover:text-amber-500 transition-colors">
                  Custom Fabrication
                </Link>
              </li>
              <li>
            ...
            <ul className="flex flex-col gap-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="leading-relaxed">
                  123 Industrial Park, Steel District, SD 45678
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="h-4 w-4 text-amber-500 shrink-0" />
                <a href="tel:+15551234567" className="hover:text-amber-500 transition-colors">
                  +1 (555) 123-4567
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-4 w-4 text-amber-500 shrink-0" />
                <a href="mailto:info@crystalmetal.com" className="hover:text-amber-500 transition-colors">
