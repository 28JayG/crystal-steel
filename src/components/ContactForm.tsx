...
const ContactFormContent: React.FC = () => {
  ...
  if (status === 'success') {
    return (
      <div className="flex flex-col items-center justify-center p-8 bg-slate-900/40 border border-emerald-500/20 rounded-lg text-center h-full">
        ...
        <Typography variant="body" className="text-slate-300 text-sm max-w-sm mb-6">
          Thank you for reaching out. A Crystal Metal specialist will review your specifications and get in touch with you within 24 business hours.
        </Typography>
        <button
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5 p-8 rounded-lg bg-[#121826] border border-slate-800 shadow-xl">
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="interest" className="text-xs font-bold text-slate-400 uppercase tracking-wider">
        ...
        >
          <option value="Steel Sheets" className="bg-[#121826]">Steel Sheets & Plates</option>
          <option value="Metal Pipes" className="bg-[#121826]">Metal Pipes & Tubes</option>
          <option value="Custom Fabrication" className="bg-[#121826]">Custom Metal Fabrication</option>
          <option value="CNC Machining" className="bg-[#121826]">Precision CNC Machining</option>
          <option value="Other" className="bg-[#121826]">Other Components / Alloys</option>
        </select>
      </div>
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="message" className="text-xs font-bold text-slate-400 uppercase tracking-wider">
          Project Specifications / Message <span className="text-amber-500">*</span>
        </label>
        <textarea
          id="message"
          name="message"
...
export const ContactForm: React.FC = () => (
  <Suspense fallback={<div className="p-8 text-center text-slate-400">Loading contact form...</div>}>
    <ContactFormContent />
  </Suspense>
);
